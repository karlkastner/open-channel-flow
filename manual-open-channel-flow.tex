...
open-channel-flow\protect\\Revision 1:6M
}
...
\end{lstlisting}
\section{w/@Potential\_Flow\_Analytic}
...
\end{lstlisting}
\section{w}
\subsection{Potential\_Flow\_Map}
${}$
\begin{lstlisting}
...
\end{lstlisting}
\section{w/meander-bend/@Equilibrium\_Bend}
...
\end{lstlisting}
\section{w/old}
\subsection{UniformFlow}
${}$
\begin{lstlisting}

\end{lstlisting}
\section{w/rating-curve}
...
\end{lstlisting}
\section{w/test/test\_Backwater1D}
...
\end{lstlisting}
\section{w/uniform-stationary-flow}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile\_with\_bend\_correction}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile\_with\_cubic\_wake}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile\_with\_dip}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile\_with\_linear\_bend\_correction}
...
\end{lstlisting}
\section{w/velocity-profile/@Log\_profile\_with\_wake}
...
\end{lstlisting}
\section{w/velocity-profile/@Vertical\_profile}
